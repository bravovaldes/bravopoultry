    ...
    <div className="space-y-4 lg:space-y-3">
      ...
      <div className="flex items-center justify-between bg-white rounded-lg border p-3">
        ...
        <div className="relative">
          ...
          {showAddMenu && lots?.length > 0 && (
            <div className="absolute right-0 mt-2 w-64 bg-white rounded-lg shadow-lg border z-50">
              <div className="p-2 border-b">
                <p className="text-xs text-gray-500 font-medium">Choisir un lot</p>
              </div>
              {lots.length > 5 && (
                <div className="p-2 border-b">
                  <input
              ...
              <div className="max-h-64 overflow-y-auto">
                {filteredLots.length > 0 ? filteredLots.map((lot: any) => (
                  <button
                    key={lot.id}
                  ...
                  <p className="px-3 py-2 text-sm text-gray-500">Aucun lot trouve</p>
                )}
              </div>
            </div>
          )}
            ...
            >
              ...
              {filteredLots.map((lot: any) => (
                <option key={lot.id} value={lot.id}>
                  {lot.name || lot.code} {lot.site_name ? `(${lot.site_name})` : ''}
                </option>
              ))}
            </select>
          </div>
      ...
      <div className="bg-white rounded-lg border">
        ...
        {isLoading ? (
          ...
          <div className="text-center py-12">
            ...
            <p className="text-sm text-gray-400 mt-1">Commencez par ajouter des donnees dans un lot</p>
          </div>
        ) : (
