      ...
      <div className="min-h-screen flex flex-col lg:flex-row">
        ...
        <div className="flex-1 flex items-center justify-center bg-white min-h-screen lg:min-h-0 py-8 sm:py-12 px-4 sm:px-6 lg:px-8">
          <div className="w-full max-w-md mx-auto text-center">
            ...
            <div className="w-20 h-20 bg-orange-100 rounded-full flex items-center justify-center mx-auto mb-6 animate-[scale-in_0.3s_ease-out]">
              <Mail className="w-10 h-10 text-orange-600" />
            </div>

            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900 mb-3">Verifiez votre email</h1>
            <p className="text-gray-600 mb-2">
              Nous avons envoye un lien de verification a:
            </p>
            <p className="font-semibold text-gray-900 mb-6">{registeredEmail}</p>

            <div className="bg-orange-50 rounded-xl p-6 text-left mb-6 border border-orange-100">
              <h3 className="font-medium text-gray-900 mb-4">Prochaines etapes:</h3>
            ...
            <button
              ...
              disabled={resending}
              className="w-full bg-gray-100 text-gray-700 py-3 px-4 rounded-xl font-medium hover:bg-gray-200 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
            >
              {resending ? (
                <>
      ...
      <div className="flex-1 flex items-center justify-center bg-white min-h-screen lg:min-h-0 py-8 px-4 sm:px-6 lg:px-8 overflow-y-auto">
        <div className="w-full max-w-md mx-auto">
          <div className="text-center mb-6">
            ...
            <h1 className="text-2xl sm:text-3xl font-bold text-gray-900">Creer un compte</h1>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    type="text"
                    {...register('first_name')}
                    className="w-full pl-10 pr-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all text-sm"
                    placeholder="Jean"
                  />
                </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-11 pr-4 py-2.5 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all"
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    {...register('password')}
                    className="w-full pl-10 pr-10 py-2.5 border border-gray-200 rounded-xl bg-gray-50 focus:bg-white focus:ring-2 focus:ring-orange-500/20 focus:border-orange-500 transition-all text-sm"
                    placeholder="••••••••"
                  />
                  <button
                    type="button"
